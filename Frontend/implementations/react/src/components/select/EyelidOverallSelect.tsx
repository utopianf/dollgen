...
export const EyelidOverallSelect = () => {
    const { pixelStreaming } = useContext(PixelStreamingContext)
    return (
        <>
            <Label htmlFor="eyelidoverall">Eyelid overall</Label>
            <Select.Root defaultValue='2' onValueChange={(value) => {
                if (pixelStreaming) {
                    pixelStreaming.emitUIInteraction({
                        parameter: 'eyelid_overall',
                        value: value,
                    })
                }
            }}>
                <SelectTrigger id="eyelidoverall" aria-label="eyelid">
                    <Select.Value />
                    <SelectIcon>
                        <ChevronDownIcon />
                    </SelectIcon>
...
export default EyelidOverallSelect;