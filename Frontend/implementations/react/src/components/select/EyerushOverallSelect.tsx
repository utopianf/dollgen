...
export const EyerushOverallSelect = () => {
    const { pixelStreaming } = useContext(PixelStreamingContext)
    return (
        <>
            <Label htmlFor="eyerushoverall">Eyerush overall</Label>
            <Select.Root defaultValue='2' onValueChange={(value) => {
                if (pixelStreaming) {
                    pixelStreaming.emitUIInteraction({
                        parameter: 'eyerush_overall',
                        value: value,
                    })
                }
            }}>
                <SelectTrigger id="eyerushoverall" aria-label="eyerush">
                    <Select.Value />
                    <SelectIcon>
                        <ChevronDownIcon />
                    </SelectIcon>
...
export default EyerushOverallSelect;