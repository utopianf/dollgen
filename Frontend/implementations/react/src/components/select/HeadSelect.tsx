...
export const HeadSelect = () => {
    const { pixelStreaming } = useContext(PixelStreamingContext)
    return (
        <>
            <Label htmlFor="head">eye/mouse</Label>
            <Select.Root defaultValue='000' onValueChange={(value) => {
                if (pixelStreaming) {
                ...
                <SelectTrigger id="head" aria-label="Eye-Mouse">
                    <Select.Value />
                    <SelectIcon>
                        <ChevronDownIcon />
                    </SelectIcon>
                ...
                <Select.Portal>
                    <SelectContent>
                        ...
                        <SelectViewport>
                            <SelectItem value="000">open/open</SelectItem>
                            <SelectItem value="100">close/open</SelectItem>
                            <SelectItem value="011">open/close</SelectItem>
                            <SelectItem value="111">close/close</SelectItem>
                        </SelectViewport>
