...
export const HeadTab = () => {
    ...
    const isCheckbox = (param: Parameter): param is CheckboxParameter =>
        param.type === 'checkbox';
                                        ...
                                        if (checked) {
                                            ...
                                            if (pixelStreaming) {
                                                pixelStreaming.emitUIInteraction(
                                                    {
                                                        parameter: 'Tsuno.Type',
                                                        value: tsuno_type_param.value
                                                    }
                                                );
                                            }
                                        }
